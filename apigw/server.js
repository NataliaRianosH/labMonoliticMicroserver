...
const resolvers = {
  ...
  service3: async () => {
    try {
      const response = await axios.get('http://cachetadacontrucha:8282/cachetadacontrucha');
      return response.data.mensaje;
    } catch (err) {
      console.error("Error al obtener datos de Cachetada con Trucha", err);
      return "Error al obtener datos de Cachetada con Trucha";
    }
  },
  },
};
